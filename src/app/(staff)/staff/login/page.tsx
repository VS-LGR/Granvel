...
export default function StaffLoginPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[80vh] max-w-lg flex-col justify-center px-4 py-16">
      <Link href="/" className="mb-8 text-sm text-white/60 hover:text-white">
        ← Voltar ao site
      </Link>
      <h1 className="font-[family-name:var(--font-syne)] text-3xl font-semibold">Acesso da equipe</h1>
      <p className="mt-2 text-sm text-white/60">Use o e-mail e senha cadastrados no Supabase Auth.</p>
      {!env ? (
